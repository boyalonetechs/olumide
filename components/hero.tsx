  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center justify-center pb-4 pt-8">
        ...
        <h1
          aria-hidden
          className="pointer-events-none absolute top-85 left-1/2 z-0 -translate-x-1/2  select-none text-[15vw] font-black uppercase leading-none tracking-tighter text-transparent opacity-90 md:-translate-y-80 md:text-[16vw]"
          style={{
            backgroundImage: "linear-gradient(to bottom, #27272a, #18181b, #000)",
        ...
        {/* Centered portrait */}
        <div className="relative z-10 mt-0 w-full max-w-md md:max-w-lg">
          <Avatar
            src="/hero-t.png"
            alt="Olumide Faleye"
            className="aspect-[4/4.9] w-full rounded-2xl  md:bg-transparent"
          />
        </div>
        ...
        <div className="pointer-events-none absolute inset-x-0 top-1/2 hidden -translate-y-1/2 items-center justify-between px-4 md:flex">
          <div className="pointer-events-auto max-w-xs text-xs font-normal leading-relaxed text-zinc-800">
            Hello, I&apos;m <strong className="font-semibold">Olumide Faleye</strong>, a{" "}
            <strong className="font-semibold">Data Analyst</strong>. I transform data into
            smarter decisions and help organizations improve performance.
          </div>
          <div className="pointer-events-auto max-w-xs text-right text-xs font-normal leading-relaxed text-zinc-800">
            I build interactive dashboards and reports that enable decision-makers to
            understand their business and uncover growth opportunities.
          </div>
        </div>
      </div>
